...
print "#include \"datatypes/allele.h\""
print "#include \"datatypes/quartet.h\""
print "#include \"typedef.h\""
print 
#numpy.set_printoptions(precission=18)
for x in range(0, 3):
	system_eq.append(sympy.diff(lnL, params[x]) )
	print "inline real_t H"+str(x)+" (const quartet_t &q, const allele_t &a) {"
	print "\tconst real_t M=q.base[get_major(a)];		//count_t of the number of reads of the major allele."
	print "\tconst real_t m=q.base[get_minor(a)];		//count_t of the number of reads of the minor allele"
	print "\tconst real_t E=q.base[get_error1(a)]+q.base[get_error2(a)];	//count_t of the number of reads of niether major nor minor"
	print
	print "\tconst real_t h=get_freq(a);				//frequency of the major allele"
	print "\tconst real_t e=a.error;				//"
	print "\tconst real_t F=get_f(a);					//F statistic"
...
for x in range(0, 3):
	for y in range(0, 3):
		print "inline real_t J"+str(x)+str(y)+" (const quartet_t &q, const allele_t &a) {"
		print "\tconst real_t M=q.base[get_major(a)];		//count_t of the number of reads of the major allele."
		print "\tconst real_t m=q.base[get_minor(a)];		//count_t of the number of reads of the minor allele"
		print "\tconst real_t E=q.base[get_error1(a)]+q.base[get_error2(a)];	//count_t of the number of reads of niether major nor minor"
		print
		...
		print ";\n}\n"
print "inline real_t lnL_NR (const quartet_t &q, const allele_t &a) {"
print "\tconst real_t M=q.base[get_major(a)];		//count_t of the number of reads of the major allele."
print "\tconst real_t m=q.base[get_minor(a)];		//count_t of the number of reads of the minor allele"
print "\tconst real_t E=q.base[get_error1(a)]+q.base[get_error2(a)];	//count_t of the number of reads of niether major nor minor"
print
