...
NUMBER_REP=1000
NUMBER_LOCI=10000
sigma=["-s 0.0", "-s 188.0 -l True", "-s 192.0"]

for i in range (0, 3):
	for j in range (0, 3):
		N=0
		for y in range(0, NUMBER_REP):
			os.system("python simulate_random_IBD.py -c "+str(COV[i])+" "+sigma[j]+" -N "+str(NUMBER_LOCI)+" -M "+str(CM[0])+" > sim/temp.txt")
...
for i in range (0, 3):
	for j in range (0, 3):
		print sigma[j], "&", COV[i], "&", round( (A[i][j][3])*10**3,2), "&" , round( (B[i][j][3])*10**4, 2), "&&", round( (AI[i][j][3])*10**3,2), "&" , round( (BI[i][j][3])*10**4, 2), "&&", round( (A2[i][j][3])*10**3,2), "&" , round( (B2[i][j][3])*10**4, 2), "&&", round( (AI2[i][j][3])*10**3,2), "&" , round( (BI2[i][j][3])*10**4, 2), "\\\\"
	print "\\hline"
...
for i in range (0, 3):
	for j in range (0, 3):
		print sigma[j], "&", COV[i], "&", round( (A[i][j][7])*10**3,2), "&" , round( (B[i][j][7])*10**4, 2), "&&", round( (AI[i][j][7])*10**3,2), "&" , round( (BI[i][j][7])*10**4, 2), "&&", round( (A2[i][j][7])*10**3,2), "&" , round( (B2[i][j][7])*10**4, 2), "&&", round( (AI2[i][j][7])*10**3,2), "&" , round( (BI2[i][j][7])*10**4, 2), "\\\\"
	print "\\hline"
...
for i in range (0, 3):
	for j in range (0, 3):
		print sigma[j], "&", COV[i], "&", round( (A[i][j][1]+A[i][j][2])*10**3/2.,2), "&" , round( (B[i][j][1]+B[i][j][2])/2.*10**4, 2), "&&", round( (AI[i][j][1]+A2[i][j][2])/2.*10**3,2), "&" , round( (BI[i][j][1]+B2[i][j][2])/2.*10**4, 2), "&&", round( (A2[i][j][1]+A2[i][j][2])*10**3/2.,2), "&" , round( (B2[i][j][1]+B2[i][j][2])/2.*10**4, 2), "&&", round( (AI2[i][j][1]+AI2[i][j][2])/2.*10**3,2), "&" , round( (BI2[i][j][1]+BI2[i][j][2])/2.*10**4, 2), "\\\\"
	print "\\hline"
print "\\end{tabular}%"
print "\\end{table}"
