...
/* @brief : A command parser that uses functors to set variables. 
* 
*  TODO: FIND SOME STANDARDS TO FOLLOW!
*/

/*@breif : tells you whether a string is an int */
/*@ : tells you whether a string is an int */
...
/*@breif : sets a vector of strings from a string*/
...
/*@brief : sets a vector of ints from a string. */
...
void printHelp(env_t env)
{
	...
	for (std::list <com_t>::iterator com=env.commands.begin(); com!=env.commands.end(); ++com){
