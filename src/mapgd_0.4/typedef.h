...
typedef uint8_t count_t;	//Should be used to specify deapth of coverage only. Currently used for evetything. 
...
typedef int64_t	id1_off_t;	//specifies a distance between bp, must addres -id1_t to +id1_t.
