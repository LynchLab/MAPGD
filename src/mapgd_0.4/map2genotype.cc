...
int map2genotype(int argc, char *argv[])
{
	...
	env.required_arg('p',"pro", proname, "please provide a real number.", "the name of the pro file (should be generated by the -p option of mapgd allele, not mapgd proview).");
